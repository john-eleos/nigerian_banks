...
//      String parsedBankName  =  controller.text;
      ...
      getBankName(parsedBankName, this.bank?.name)
          .then((bankName) {
        if (bankName == null) {
          ...
          if (widget.onInputChanged != null) {
            setState(() {controller.text=bankName;});
            widget.onInputChanged(BankModel(
              name:bankName,
              slug:this.bank?.slug,
              code:this.bank?.code,
  ...
  InputDecoration getInputDecoration({InputDecoration decoration, Widget prefix}) {
    return decoration != null ?
           InputDecoration(
             ...
             suffixIcon:decoration?.suffixIcon??Icon(Icons.keyboard_arrow_down, color: Color(0xFF12326B),),
